    ...
    <Fragment>
      ...
      <div className="Pharmacie_1_container">
        <div className="project_display">
          <h1 className="project_title">Pharmacie Design</h1>
          <h3 className="project_description">
            par Pape Momar Ndiaye | 27 Mai, 2022 |
          </h3>
          <p>
            Nous avons une vaste expérience dans l'aménagement d'espaces communs
            et de bureaux, quelle que soit leur typologie, leur vocation, leur
            stratégie et leur positionnement.{" "}
          </p>
          ...
          <div className="TheImageContainer">
            <img
              ...
              src={ImageProjectC7}
              width="47%"
              alt="  Pharmacie Design - 7"
            />
            <img
              onClick={displayImage}
              src={ImageProjectC8}
              width="47%"
              alt="  Pharmacie Design - 8"
            />
          </div>
        </div>
      </div>
