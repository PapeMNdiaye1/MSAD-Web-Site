    ...
    <Fragment>
      ...
      <div className="Hangar_1_container">
        <div className="project_display">
          <h1 className="project_title">Maquette Hangar Photovoltaïque</h1>
          ...
          <div className="TheImageContainer">
            <img
              ...
              src={ImageProjectC2}
              width="100%"
              alt=" Maquette Hangar Photovoltaïque - 1"
            />
          </div>
          <div className="TheImageContainer">
            <img
              ...
              src={ImageProjectC4}
              width="47%"
              alt=" Maquette Hangar Photovoltaïque - 2"
            />
            <img
              loading="lazy"
              onClick={displayImage}
              src={ImageProjectC3}
              width="47%"
              alt=" Maquette Hangar Photovoltaïque - 3"
            />
          </div>
          <div className="TheImageContainer">
            <img
              ...
              src={ImageProjectC1}
              width="100%"
              alt=" Maquette Hangar Photovoltaïque - 4"
            />
          </div>
        </div>
      </div>
